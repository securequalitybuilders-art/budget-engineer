...
import { Building2, Briefcase, Package, MapPin, ChevronRight, ChevronLeft, Check, AlertCircle, Globe, Phone, Mail, Building, Users, Calendar, Award, FileText, Shield, HelpCircle, X, Sparkles } from 'lucide-react';
