...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: '/project/:id/studio/ledger',
        element: <SafeRoute><LedgerStudio /></SafeRoute>,
      },
      {
        path: '/project/:id/studio/wipaa',
        element: <SafeRoute><WipaaStudio /></SafeRoute>,
      },
      {
      ...
      {
        path: '/project/:id/studio/agent',
        element: <SafeRoute><AgentStudio /></SafeRoute>,
      },
      {
