  ...
  return [
    {
      ...
      elements: [
        ...
        { id: uuid(), category: 'slab', material: 'concrete', dimensions: { width: 12, length: 10 } , quantity: { value: 120, unit: 'm2', formula: '12m × 10m' } },
        ...
        { id: uuid(), category: 'foundation', material: 'concrete', dimensions: { length: 44, width: 0.5 } , quantity: { value: 13.2, unit: 'm3', formula: '44m × 0.5m × 0.6m' } },
    ...
    },
    {
      ...
      elements: [
        ...
        { id: uuid(), category: 'slab', material: 'concrete', dimensions: { width: 10, length: 10 } , quantity: { value: 100, unit: 'm2', formula: '10m × 10m' } },
        ...
        { id: uuid(), category: 'foundation', material: 'concrete', dimensions: { length: 40, width: 0.5 } , quantity: { value: 12, unit: 'm3', formula: '40m × 0.5m × 0.6m' } },
    ...
    },
    {
      ...
      elements: [
        ...
        { id: uuid(), category: 'slab', material: 'concrete', dimensions: { width: 14, length: 10 } , quantity: { value: 140, unit: 'm2', formula: '14m × 10m' } },
        ...
        { id: uuid(), category: 'foundation', material: 'concrete', dimensions: { length: 48, width: 0.5 } , quantity: { value: 14.4, unit: 'm3', formula: '48m × 0.5m × 0.6m' } },
