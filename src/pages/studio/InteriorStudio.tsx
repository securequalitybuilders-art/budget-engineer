...
function RoomTemplatesSidebar({ project }: { project: InteriorProject }) {
  return (
    ...
    return (
      <div className="flex h-full flex-col">
        ...
        <div className="flex flex-1 gap-4 overflow-hidden p-4">
          <div className="flex flex-col gap-3 flex-shrink-0" style={{ width: 220 }}>
            <RoomTemplatesSidebar project={project} />
          </div>
          <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed border-[var(--border-primary)]">
            <p className="text-sm text-[var(--text-tertiary)]">Select a room template on the left to get started</p>
          </div>
        </div>
      </div>
    );
