...
/**
 * Returns a human-readable reason a given user cannot perform an action, or
 * undefined when the action is permitted. Used to render explicit unauthorized
 * messaging next to disabled controls instead of silently disabling them.
 */
