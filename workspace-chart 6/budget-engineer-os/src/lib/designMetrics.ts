// ============================================================================
// Stage 62 — Design metrics + change summary
// Snapshots a small set of headline metrics so we can show WHAT changed since
// the last issued revision (not just THAT it changed).
// ============================================================================

import { CadDocument, BimModel, BOQ } from '../domain/types';
...
/** Produce a human-readable list of changes from `prev` → `curr`. */
export function summarizeChanges(prev: DesignMetrics, curr: DesignMetrics): ChangeLine[] {
  ...
  // cost change as its own formatted line
