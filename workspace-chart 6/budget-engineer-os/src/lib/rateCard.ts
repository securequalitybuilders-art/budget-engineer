...
// Rate cards per region/currency, replacing hard-coded constants in the BOQ
// generator. Cards are presets but fully overridable in the UI and persisted.
// Based on open construction cost references (CWICR-style structure).
// ============================================================================
